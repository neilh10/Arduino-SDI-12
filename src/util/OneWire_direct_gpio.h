...
#warning "SDI-12 - Fallback mode. Using API calls for pinMode, digitalRead, and digitalWrite. Operation of this library is not guaranteed on this architecture."
